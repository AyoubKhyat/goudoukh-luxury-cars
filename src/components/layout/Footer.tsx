...
export default function Footer() {
  ...
  const socialLinks = [
    { label: "Instagram", icon: <InstagramIcon />, href: "https://instagram.com/goudoukh" },
    { label: "Facebook", icon: <FacebookIcon />, href: "https://facebook.com/goudoukh" },
    { label: "YouTube", icon: <YouTubeIcon />, href: "https://youtube.com/@goudoukh" },
    { label: "TikTok", icon: <TikTokIcon />, href: "https://tiktok.com/@goudoukh" },
  ];
